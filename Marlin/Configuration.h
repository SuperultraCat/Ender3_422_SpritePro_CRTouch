...
#define BED_MAXTEMP      140  // Ender3V2 Configs
 ...
 */
  ...
  #define MPC_BLOCK_HEAT_CAPACITY { 11.69f }           // (J/K) Heat block heat capacities.
  #define MPC_SENSOR_RESPONSIVENESS { 0.2037f }         // (K/s per ∆K) Rate of change of sensor temperature from heat block.
  #define MPC_AMBIENT_XFER_COEFF { 0.0693f }           // (W/K) Heat transfer coefficients from heat block to room air with fan off.
  #if ENABLED(MPC_INCLUDE_FAN)
    #define MPC_AMBIENT_XFER_COEFF_FAN255 { 0.1251f }  // (W/K) Heat transfer coefficients from heat block to room air with fan on full.
  #endif
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 239.93
  #define DEFAULT_bedKi  46.86
  #define DEFAULT_bedKd 818.97
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.0266 // (mm) Distance from real junction edge
